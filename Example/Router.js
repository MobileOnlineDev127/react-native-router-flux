...
const navigationOptions = ({navigation, screenProps}) => {
  return {
    title: getValue(navigation.state.params.title, {...navigation.state.params, ...screenProps}),
    headerBackTitle: getValue(navigation.state.params.backTitle, {...navigation.state.params, ...screenProps}),
    headerRight: getValue(navigation.state.params.right, {...navigation.state.params, ...screenProps}),
    headerLeft: getValue(navigation.state.params.left, {...navigation.state.params, ...screenProps}),
    headerStyle: getValue(navigation.state.params.headerStyle, {...navigation.state.params, ...screenProps}),
  }
};
